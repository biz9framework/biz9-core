...
module.exports = function(app_config,aws_config,data_config){
    ...
    G_MONGO_FULL_URL="mongodb://"+data_config.mongo_user+":"+ data_config.mongo_password +"@"+ data_config.mongo_ip +":"+ data_config.mongo_port+"?directConnection=true&"+"maxPoolSize=20&w=majority";
